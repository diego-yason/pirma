...
<div class="px-4 mt-8">
    ...
    >
        <p class="col-span-3">Q3 Non-Disclosure Agreement</p>
        <p class="col-span-2">Juan Dela Cruz (you)</p>
        <p class="">21 June 2026</p>
        <p class="">Awaiting Signatories</p>
        <!-- TODO: turn to options menu -->
